...
/**
 * @author hmehmeti Kunden Object for DBPersistence
 *
 */
public class CustomerViewModel {
	...
	public StringProperty getAddress() {
		StringProperty address = new SimpleStringProperty(getStreet().get() + " " + getNo().get() + " "
				+ getPostCode().get() + " " + getCity().get() + " " + getCountry().get());
